...
6. [PENDING] Fast path: avoid map creation for empty payloads end‑to‑end.
7. [PENDING] gRPC response compression for large responses (evaluate CPU vs bandwidth).
...
5. [PENDING] Use bulk loading path for initial indexing.
