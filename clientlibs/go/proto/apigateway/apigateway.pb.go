...
const file_apigateway_proto_rawDesc = "" +
	...
	"\x13GetCollectionStatus\x12&.vectron.v1.GetCollectionStatusRequest\x1a'.vectron.v1.GetCollectionStatusResponse\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/v1/collections/{name}/statusB?Z=github.com/pavandhadge/vectron/clientlibs/go/proto/apigatewayb\x06proto3"
...
var file_apigateway_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
