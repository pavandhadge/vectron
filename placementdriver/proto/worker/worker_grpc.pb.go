...
const (
	Worker_StoreVector_FullMethodName  = "/worker.Worker/StoreVector"
	Worker_GetVector_FullMethodName    = "/worker.Worker/GetVector"
	Worker_DeleteVector_FullMethodName = "/worker.Worker/DeleteVector"
	Worker_Search_FullMethodName       = "/worker.Worker/Search"
	Worker_Put_FullMethodName          = "/worker.Worker/Put"
	Worker_Get_FullMethodName          = "/worker.Worker/Get"
	Worker_Delete_FullMethodName       = "/worker.Worker/Delete"
	Worker_Status_FullMethodName       = "/worker.Worker/Status"
	Worker_Flush_FullMethodName        = "/worker.Worker/Flush"
)
